...
class _FoodPageState extends State<FoodPage> {
  ...
  final Color cardYellow = const Color(0xFFFFB300);
  final Color cardGreen = const Color(0xFF43A047);
  ...
  Color _calculateColorFromDate(String expiryDateString) {
    try {
      ...
      if (difference <= 3) return cardRed;
      if (difference <= 7) return cardYellow;
      return cardGreen;
    } catch (e) {
      return cardGreen;
    }
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const ExpiredPage(),
                              ),
                            );
                          },
                        ),
                  ...
                  builder: (context, snapshot) {
                    ...
                    var items = snapshot.data!.docs
                        ...
                        .where((item) {
                          ...
                          bool isEaten = item['isEaten'] ?? false;
